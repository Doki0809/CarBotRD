...
// Auto-login anónimo para Firebase Storage (ya que Auth principal ahora es Supabase, pero Storage sigue en Firebase y pide auth)
signInAnonymously(auth).catch((error) => console.error("Firebase Anon Auth failed:", error));
